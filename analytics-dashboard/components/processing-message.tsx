...
export function ProcessingMessage({ processingStages }: ProcessingMessageProps) {
  return (
    <div className="flex justify-start">
      <div className="bg-gradient-to-br from-purple-600 to-primary text-primary-foreground rounded-lg p-6 max-w-2xl w-full">
        ...
        <div className="mb-6">
          <div className="w-full bg-primary-foreground/20 rounded-full h-2 mb-4">
            <div
              ...
              style={{
                width: `${Math.max(...processingStages.map((s) => s.progress)) || 0}%`,
              }}
            ></div>
          </div>
        </div>
