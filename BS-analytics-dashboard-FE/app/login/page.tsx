...
export default function LoginPage() {
  ...
  try {
    ...
    // Redirect to the main dashboard page, not the login-specific dashboard route
...
const handleSocialLogin = async (provider: string) => {
  ...
  try {
    // Create a mock user for social login (bypassing API call for now)
    const mockUser = {
      ...
      email: provider === "google" 
        ? "user.google@bluesherpa.com" 
        : "user.microsoft@bluesherpa.com",
      role: "Data Analyst",
      profile_image: null
    }
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="text-center pt-0">
            ...
            <div className="mt-4 p-3 bg-muted/50 rounded-lg text-xs text-muted-foreground">
              ...
              <p>Email: any valid email (e.g., user@example.com)</p>
